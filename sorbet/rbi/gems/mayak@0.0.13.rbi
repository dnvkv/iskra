...
# @abstract Subclasses must implement the `abstract` methods below.
#
# source://mayak//lib/mayak/decoder.rb#5
module Mayak::Decoder
  ...
  # @abstract
  #
  # source://mayak//lib/mayak/decoder.rb#20
  sig { abstract.params(response: RequestType).returns(Mayak::Monads::Try[RequestEntity]) }
  def decode(response); end
end

# @abstract Subclasses must implement the `abstract` methods below.
#
# source://mayak//lib/mayak/encoder.rb#5
module Mayak::Encoder
  ...
  # @abstract
  #
  # source://mayak//lib/mayak/encoder.rb#16
  sig { abstract.params(entity: ResponseEntity).returns(ResponseType) }
  def encode(entity); end

  # source://mayak//lib/mayak/encoder.rb#24
  sig do
    type_parameters(:NewResponse)
      .params(
        blk: T.proc.params(arg0: ResponseType).returns(T.type_parameter(:NewResponse))
      ).returns(Mayak::Encoder[ResponseEntity, T.type_parameter(:NewResponse)])
  end
  def map_request(&blk); end
end

# source://mayak//lib/mayak/encoder.rb#30
...
class Mayak::FailableFunction
  ...
  # source://mayak//lib/mayak/failable_function.rb#14
  sig { params(blk: T.proc.params(input: Input).returns(Mayak::Monads::Try[Output])).void }
  def initialize(&blk); end

  # @param another [Mayak::FailableFunction[T.type_parameter(:Input2), Input]]
  # @return [Mayak::FailableFunction[T.type_parameter(:Input2), Output]]
  #
  # source://sorbet-runtime/0.5.11349/lib/types/private/methods/_methods.rb#257
  def <<(*args, **_arg1, &blk); end

  # @param another [Mayak::FailableFunction[Output, T.type_parameter(:Output2)]]
  # @return [Mayak::FailableFunction[Input, T.type_parameter(:Output2)]]
  #
  # source://sorbet-runtime/0.5.11349/lib/types/private/methods/_methods.rb#257
  def >>(*args, **_arg1, &blk); end

  # source://mayak//lib/mayak/failable_function.rb#56
  sig do
    type_parameters(:Output2)
      .params(
        another: Mayak::FailableFunction[Output, T.type_parameter(:Output2)]
      ).returns(Mayak::FailableFunction[Input, T.type_parameter(:Output2)])
  end
  def and_then(another); end

  # source://mayak//lib/mayak/failable_function.rb#37
  sig { params(input: Input).returns(Mayak::Monads::Try[Output]) }
  def call(input); end

  # source://mayak//lib/mayak/failable_function.rb#68
  sig do
    type_parameters(:Input2)
      .params(
        another: Mayak::FailableFunction[T.type_parameter(:Input2), Input]
      ).returns(Mayak::FailableFunction[T.type_parameter(:Input2), Output])
  end
  def compose(another); end

  # source://mayak//lib/mayak/failable_function.rb#47
  sig { returns(Mayak::Function[Input, Mayak::Monads::Try[Output]]) }
  def to_function; end

  # source://mayak//lib/mayak/failable_function.rb#42
  sig { returns(T.proc.params(arg0: Input).returns(Mayak::Monads::Try[Output])) }
  def to_proc; end

  class << self
    # source://mayak//lib/mayak/failable_function.rb#83
    sig do
      type_parameters(:Input, :Output)
        .params(
          function: Mayak::Function[T.type_parameter(:Input), Mayak::Monads::Try[T.type_parameter(:Output)]]
        ).returns(Mayak::FailableFunction[T.type_parameter(:Input), T.type_parameter(:Output)])
    end
    def from_function(function); end

    # source://mayak//lib/mayak/failable_function.rb#32
    sig do
      type_parameters(:Input, :Output)
        .params(
          proc: T.proc.params(arg0: T.type_parameter(:Input)).returns(Mayak::Monads::Try[T.type_parameter(:Output)])
        ).returns(Mayak::FailableFunction[T.type_parameter(:Input), T.type_parameter(:Output)])
    end
    def from_proc(proc); end
  end
end
...
# @abstract Subclasses must implement the `abstract` methods below.
#
# source://mayak//lib/mayak/hash_serializable.rb#5
module Mayak::HashSerializable
  interface!

  # @abstract
  #
  # source://mayak//lib/mayak/hash_serializable.rb#12
  sig { abstract.returns(T::Hash[::String, T.untyped]) }
  def serialize; end
end

# source://mayak//lib/mayak/http/decoder.rb#7
...
# @abstract Subclasses must implement the `abstract` methods below.
#
# source://mayak//lib/mayak/http/decoder.rb#8
module Mayak::Http::Decoder
  ...
  class << self
    # source://mayak//lib/mayak/http/decoder.rb#25
    sig do
      type_parameters(:A)
        .params(
          blk: T.proc.params(arg: ::String).returns(Mayak::Monads::Try[T.type_parameter(:A)])
        ).returns(Mayak::Http::Decoder[T.type_parameter(:A)])
    end
    def decode_body(&blk); end
  end
end

# source://mayak//lib/mayak/http/decoder.rb#49
class Mayak::Http::Decoder::FunctionFromBodyDecoder < ::T::Struct
  extend T::Generic
  include ::Mayak::Decoder
  include ::Mayak::Http::Decoder
  ...
  # source://mayak//lib/mayak/http/decoder.rb#66
  sig { override.params(response: RequestType).returns(Mayak::Monads::Try[RequestEntity]) }
  def decode(response); end
...
# source://mayak//lib/mayak/http/decoder.rb#29
class Mayak::Http::Decoder::IdentityDecoder
  ...
  # source://mayak//lib/mayak/http/decoder.rb#44
  sig { override.params(response: RequestType).returns(Mayak::Monads::Try[RequestEntity]) }
  def decode(response); end
end
...
class Mayak::Http::Encoder::FromFunction
  ...
  # source://mayak//lib/mayak/http/encoder.rb#45
  sig { params(function: T.proc.params(response: ResponseEntity).returns(ResponseType)).void }
  def initialize(&function); end

  # source://mayak//lib/mayak/http/encoder.rb#50
  sig { override.params(entity: ResponseEntity).returns(ResponseType) }
  def encode(entity); end
end

# source://mayak//lib/mayak/http/encoder.rb#55
class Mayak::Http::Encoder::FromHashSerializableJson < ::T::Struct
  extend T::Generic
  include ::Mayak::Encoder
  include ::Mayak::Http::Encoder
  ...
  # source://mayak//lib/mayak/http/encoder.rb#69
  sig { override.params(entity: ResponseEntity).returns(ResponseType) }
  def encode(entity); end
...
# source://mayak//lib/mayak/http/encoder.rb#18
...
module Mayak::Json
  class << self
    ...
    sig do
      params(
        obj: T.any(::Float, ::Integer, ::String, T::Array[T.untyped], T::Hash[T.untyped, T.untyped])
      ).returns(::String)
    end
    def dump(obj); end

    # source://mayak//lib/mayak/json.rb#29
    sig do
      params(
        string: ::String
    ...
    # source://mayak//lib/mayak/json.rb#36
    sig do
      params(
        string: ::String
...
# source://mayak//lib/mayak/monads/try.rb#5
...
# source://mayak//lib/mayak/optional_function.rb#5
class Mayak::OptionalFunction
  ...
  # source://mayak//lib/mayak/optional_function.rb#14
  sig { params(blk: T.proc.params(input: Input).returns(Mayak::Monads::Maybe[Output])).void }
  def initialize(&blk); end

  # @param another [Mayak::OptionalFunction[T.type_parameter(:Input2), Input]]
  # @return [Mayak::OptionalFunction[T.type_parameter(:Input2), Output]]
  #
  # source://sorbet-runtime/0.5.11349/lib/types/private/methods/_methods.rb#257
  def <<(*args, **_arg1, &blk); end

  # @param another [Mayak::OptionalFunction[Output, T.type_parameter(:Output2)]]
  # @return [Mayak::OptionalFunction[Input, T.type_parameter(:Output2)]]
  #
  # source://sorbet-runtime/0.5.11349/lib/types/private/methods/_methods.rb#257
  def >>(*args, **_arg1, &blk); end

  # source://mayak//lib/mayak/optional_function.rb#38
  sig do
    type_parameters(:Output2)
      .params(
        another: Mayak::OptionalFunction[Output, T.type_parameter(:Output2)]
      ).returns(Mayak::OptionalFunction[Input, T.type_parameter(:Output2)])
  end
  def and_then(another); end

  # source://mayak//lib/mayak/optional_function.rb#19
  sig { params(input: Input).returns(Mayak::Monads::Maybe[Output]) }
  def call(input); end

  # source://mayak//lib/mayak/optional_function.rb#50
  sig do
    type_parameters(:Input2)
      .params(
        another: Mayak::OptionalFunction[T.type_parameter(:Input2), Input]
      ).returns(Mayak::OptionalFunction[T.type_parameter(:Input2), Output])
  end
  def compose(another); end

  # source://mayak//lib/mayak/optional_function.rb#29
  sig { returns(Mayak::Function[Input, Mayak::Monads::Maybe[Output]]) }
  def to_function; end

  # source://mayak//lib/mayak/optional_function.rb#24
  sig { returns(T.proc.params(arg0: Input).returns(Mayak::Monads::Maybe[Output])) }
  def to_proc; end

  class << self
    # source://mayak//lib/mayak/optional_function.rb#65
    sig do
      type_parameters(:Input, :Output)
        .params(
          function: Mayak::Function[T.type_parameter(:Input), Mayak::Monads::Maybe[T.type_parameter(:Output)]]
        ).returns(Mayak::OptionalFunction[T.type_parameter(:Input), T.type_parameter(:Output)])
    end
    def from_function(function); end
  end
end
...
# @abstract Subclasses must implement the `abstract` methods below.
#
# source://mayak//lib/mayak/validation_result.rb#5
module Mayak::ValidationResult
  ...
  # source://mayak//lib/mayak/validation_result.rb#34
  sig { returns(T::Boolean) }
  def invalid?; end

  # @abstract
  #
  # source://mayak//lib/mayak/validation_result.rb#25
  sig do
    abstract
      .type_parameters(:NewError)
      .params(
        blk: T.proc.params(arg: Error).returns(T.type_parameter(:NewError))
      ).returns(Mayak::ValidationResult[T.any(Error, T.type_parameter(:NewError))])
  end
  def map_errors(&blk); end

  # source://mayak//lib/mayak/validation_result.rb#43
  sig do
    type_parameters(:A)
      .params(
        blk: T.proc.returns(T.type_parameter(:A))
      ).returns(T.any(Mayak::ValidationResult::Invalid[Error], T.type_parameter(:A)))
  end
  def on_valid(&blk); end

  # source://mayak//lib/mayak/validation_result.rb#29
  sig { returns(T::Boolean) }
  def valid?; end

  class << self
    # source://mayak//lib/mayak/validation_result.rb#52
    sig { params(exceptions: T::Array[::StandardError]).returns(Mayak::ValidationResult[::StandardError]) }
    def from_exceptions(exceptions); end

    # source://mayak//lib/mayak/validation_result.rb#61
    sig { params(strings: T::Array[::String]).returns(Mayak::ValidationResult[::String]) }
    def from_strings(strings); end
  end
end

# source://mayak//lib/mayak/validation_result.rb#91
class Mayak::ValidationResult::Invalid < ::T::Struct
  extend T::Generic
  ...
  # source://mayak//lib/mayak/validation_result.rb#110
  sig do
    override
      .type_parameters(:NewError)
      .params(
...
# source://mayak//lib/mayak/validation_result.rb#69
class Mayak::ValidationResult::Valid
  extend T::Generic
  include ::Mayak::ValidationResult

  Error = type_member

  # source://mayak//lib/mayak/validation_result.rb#86
  sig do
    override
      .type_parameters(:NewError)
      .params(
